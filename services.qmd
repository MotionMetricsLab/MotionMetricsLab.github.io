...
::: {#fig-Joint_angles layout-ncol=2}

![Hip Angle](img/permutation_test_singlecycle.png){#fig-hip_angle}

![Clustering dimensions](img/permutation_test_settings.png){#fig-clustering_dimensions}

Joint angle analysis in Parkinson with sensitive testing of clustering apporaches.  
:::
